(defproject org-clock-stats "0.1.0-SNAPSHOT"
  ...
  :main ^:skip-aot org-clock-stats.core
  ...
  {:uberjar {:omit-source true
             ...
             :aot :all
             :uberjar-name "org-clock-stats.jar"
                  ...
                  {:builds
                   {:app
                    {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                     :figwheel {:on-jsload "org-clock-stats.core/mount-components"}
                     :compiler
                     {:main "org-clock-stats.app"
                      :asset-path "/js/out"
                      :output-to "target/cljsbuild/public/js/app.js"
                   ...
                   {:test
                    {:source-paths ["src/cljc" "src/cljs" "test/cljs"]
                     ...
                     {:output-to "target/test.js"
                      :main "org-clock-stats.doo-runner"
