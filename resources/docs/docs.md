...
The `home-routes` handler in the `org-clock-stats.routes.home` namespace
...
The `home-page` function will in turn call the `org-clock-stats.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/org_clock_stats/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `org-clock-stats.handler` namespace:
...
Request middleware functions are located under the `org-clock-stats.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `org-clock-stats.dev-middleware` namespace found in
